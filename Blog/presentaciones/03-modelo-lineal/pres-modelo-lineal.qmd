...
+ **Aunque clasificar puede parecer una tarea simple, muchas cosas dependen jus+ tamente de como se hace.**
...
## ¿Qué valores toman las X, las R y las H? {.center}
...
+ Ocurre cuando los valores de una variable pueden expresarse como combinaciones lineales (sumas o restas de _múltiplos_ o _submúltiplos_) de las otras variables en el conjunto.
+ A la dependencia lineal También se le denomina __colinealidad__ o __multicolinealidad__.
