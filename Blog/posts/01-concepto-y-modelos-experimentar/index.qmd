...
::: {.callout-tip title="¿Por qué funcionaría esto?" collapse="true"}

![](images/geometry-1922743_1280.jpg)
:::

2.  Aumentar la precisión con la que se estima $\sigma^2$,

::: {.callout-tip title="¿Cómo se puede hacer esto?", collapse="true"}
...
![](images/clase_1-conceptos-prueba-hipotesis.png){width="200"}
:::
