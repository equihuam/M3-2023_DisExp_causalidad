...
::: {.callout-tip title="¿qué pasaría?"}

![](images/confused-2681507_1280.jpg){width="50%"}

::: {.callout-note title="Programar para explorar ideas" collapse="true"}
...
:::{.callout-tip title="¿Tú que piensas?"}
...
**Fuente:** Stoddart, C. (2016). Is there a reproducibility crisis in science? **Nature**, 3-5. <https://doi.org/10.1038/d41586-019-00067-3>
