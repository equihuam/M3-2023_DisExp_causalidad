...
Para obtener más ayuda, les recomendamos acercarse a [dagitty](dagitty.net), que es un sitio de aprendizaje y uso de **DAGs**. Ahí hay na herramienta de dibujo de **DAGs** y permite explorar opciones para el diseño de estudios y _recibir consejos_ sobre la calidad de la estimación que distintos enfoques de diseño pueden ofrecer. Con esta herramienta produjimos este resultado. Esta herramienta también está disponible como una biblioteca para **R**. 
