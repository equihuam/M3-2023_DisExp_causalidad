...
plot(aspirina_dag)
```
ahora averiguo que condiciones de independencia implica este _grgafo_
...
Si tengo datos, puedo poner a prueba la correspondencia del **DAG** con lo _observado_.

```{r}
datos_aspirina_test <- datos_aspirina %>% 
                       mutate(A = as.numeric(A) - 1)
