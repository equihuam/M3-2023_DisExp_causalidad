...
![](images/clase_1 - Leyes en ecología0.png)

![](images/clase_1 - Leyes en ecología1.png)
:::
...
![](images/clase_1 - Leyes en ecología1.png){width="200"}
:::

## {background-iframe="https://vevox.app/#/m/152551925" background-interactive=true}

## Bacon y la ciencia occidental

:::{.r-fit-text}
- **Sir Francis Bacon (1561-1626)** clave en el origen de la ciencia occidental.
- En su *Novum Organum* (1620) plantea substituir el ya entonces viejo método aristotélico (dominate por más de 1800 años), por un _nuevo órgano_ basado en el **estudio inductivo de la naturaleza**.
- Intentaba:
    - [_Iniciar una reconstrucción total de las ciencias, las artes prácticas y todo el conocimiento humano, erigida sobre fundamentos apropiados_]{style="color:#A61C00"} .
...
- Está presente a cada paso de la creación científica
  - Es clave para culminar el complicado proceso inductivo
  - Es determinante al **explicar los hallazgos**
...
## ¿Qué supuestos damos por sentados cuando hacemos ciencia?
...
- Durante la primera mitad del siglo XX se sostuvo con bastante generalidad la convicción de que la **causalidad en ciencia era un** **proceso** __determinista__, mecanicista.
...
- Cook y Campbell (1979) afirmaban hace tiempo que “la epistemología de la causalidad y de los métodos científicos más en general, atraviesaba por un _productivo estado_ de casi caos”.
...
**Fuente: Yearley, S. (2005).** *Making sense of science (understanding the social study of science).* __Sage. London, 205 pp.__
