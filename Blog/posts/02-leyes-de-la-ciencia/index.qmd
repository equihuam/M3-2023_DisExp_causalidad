...
A continuación encontraran la presentación que usamos como apoyo audiovisual para conducir la exploración de los temas que discutimos en esta sesión (_haz click en la imágen_).


:::{layout="[[-20, 60, -20]]" layout-valign="top"}

[![](images/mathematics-1233876_1280.jpg){width="300"}](Pres-leyes-ciencia.qmd)
