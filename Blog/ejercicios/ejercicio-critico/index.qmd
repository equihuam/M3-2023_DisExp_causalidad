...
1. Comentar la relación entre ambas variables
1. Comparar los resultados de este monitoreo con la información a nivel local 
1. Comentar si los resultados de este monitoreo sirven para los objetivos propuestos
...
1. Comparar la inundación entre los dos tratamientos (PRotección y REstauración)
1. Aplicar un modelo lineal a la variable inundación, dependiente de la variable tiempo
1. Comentar si los resultados de este monitoreo sirven para los objetivos.
1. Comparar estos datos con información a nivel mundial
1. _Opcional_ Hacer un análisis de serie de tiempo: descomponer tendencia y estacionalidad y hacer un pronóstico
